...
import { useUploadImage } from '../hooks/api/useUser'
...
const ImageUploader: React.FC<ImageUploaderProps> = ({
  ...
  const handleImageSelected = async (imageUri: string) => {
    setLocalImageUri(imageUri) // Hiển thị ảnh local ngay lập tức

    try {
      console.log('Starting image upload for:', imageUri)

      // Upload ảnh lên server
      const uploadedUrl = await uploadImageMutation.mutateAsync(imageUri)

      console.log('Upload successful, received URL:', uploadedUrl)
      ...
      setLocalImageUri('') // Xóa ảnh local nếu upload thất bại
  ...
  // Sử dụng localImageUri nếu có, nếu không thì dùng value từ server
